...
<?php
echo '<div class="disp">';
$sql = "SELECT productname,price,descr,productid,quantity FROM productdisplay WHERE categoryid IN (SELECT categoryid FROM category WHERE categoryname='electronics')";
